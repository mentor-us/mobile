...
import AddChannelScreenProvider, {
  useAddChannelScreenState,
...
import { GetWorkspaceQueryKey } from "~/app/server/groups/queries";
...
const AddChannel: ScreenProps<"addChannel"> = ({ route }) => {
  ...
  const onRightPress = useCallback(() => {
    ...
    if (state.screenType === "form") {
      ...
      queryClient.refetchQueries(GetWorkspaceQueryKey(groupId));
